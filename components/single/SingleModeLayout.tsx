...
import { ProgramItem, Source, Scene, AudioSource, BrandingState, CommentOverlayConfig, ControlSurfaceState, Overlay, ProductionMode, LightingState, BroadcastSession, StreamDestination, TransitionState, ReplayState, OutputState, ScoreboardState, Guest } from '../../types';
...
type TabId = 'audio' | 'ptz' | 'score' | 'replay' | 'overlays' | 'stream' | 'callin' | 'config';
...
const tabs: { id: TabId; label: string; icon: React.ReactNode }[] = [
    ...
    { id: 'callin', label: 'Invitados', icon: <IconUsers className="w-6 h-6"/> },
...
const GlobalActionBar: React.FC<{ 
    ...
    <div className="bg-black/90 p-2 flex items-center justify-between gap-2 border-t border-gray-700 h-16 lg:h-20">
